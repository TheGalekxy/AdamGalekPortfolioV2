...
export const featuredPortfolio = [

    {
      ...
      technologies: ["HTML5", "CSS", "JavaScript", "React", "Redux", "PostgreSQL", "NodeJS", "Git"],
      roles: ["Developer"],
      images: [],
    },
    {
      ...
      github: "",
      technologies: ["HTML5", "CSS", "JavaScript", "React", "SASS", "NodeJS", "NGINX", "Linux", "Digital Ocean", "Git"],
      roles: ["Web Developer", "Technical Lead"],
      images: [],
    },
    {
      id: 3,
      ...
      github: "",
      technologies: ["HTML5", "CSS", "SASS", "Liquid", "Git"],
      roles: ["Web Developer"],
      images: [],
    },
    {
      ...
      technologies: ["HTML5", "CSS", "JavaScript", "PHP", "MySQL", "NGINX", "Linux", "Digital Ocean", "Git"],
      roles: ["Web Developer"],
      images: [PHPKnights1, PHPKnights2, PHPKnights3, PHPKnights4, PHPKnights5],
    ...
    },
    {
      ...
      technologies: ["HTML5", "CSS", "JavaScript", "Git"],
      roles: ["Web Developer"],
      images: [],
    },
    {
  ...
  export const PHPPortfolio = [
    ...
    },
    {
      ...
      technologies: ["HTML5", "CSS", "JavaScript", "PHP", "NGINX", "Linux", "Digital Ocean", "Git"],
